...
export const applications: AppItem[] = [
  {
    ...
    size: "၁၈ MB",
    description:
      "ကုန်လက်ကျန်၊ ဂိုဒေါင်နှင့် ထောက်ပံ့သူများကို လွယ်ကူစွာ စီမံခန့်ခွဲနိုင်သော စနစ်။",
    screenshots: [clothesImg],
    status: "preview",
    features: [
      "ကုန်လက်ကျန်ကို အချိန်နှင့်တပြေးညီ ကြည့်ရှုနိုင်ခြင်း",
      "ကုန်ပစ္စည်းနည်းပါးမှု သတိပေးချက်",
      "ထောက်ပံ့သူ စီမံခန့်ခွဲခြင်း",
      "ဘားကုဒ် ပံ့ပိုးမှု",
      "ဂိုဒေါင်အများအပြား စီမံနိုင်ခြင်း",
    ],
    howToUse: [
      "ဆော့ဖ်ဝဲလ်ကို ထည့်သွင်းပါ",
      "ဂိုဒေါင်အချက်အလက် သတ်မှတ်ပါ",
      "ကုန်ပစ္စည်းများ ထည့်သွင်းပါ",
      "ကုန်အဝင်/အထွက်များကို မှတ်တမ်းတင်ပါ",
    ],
    ...
    faq: [
      ...
      {
        q: "ကွန်ပျူတာအများအပြားတွင် အသုံးပြုနိုင်ပါသလား?",
        a: "Cloud Sync ဖြင့် စက်အများအပြားတွင် အသုံးပြုနိုင်ပါတယ်။",
      },
    ],
  },
  {
